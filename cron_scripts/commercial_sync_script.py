"""
commercial_sync_script
Calls the configured sync endpoint and returns the HTTP status code and request duration.
"""
import os
...
def main():
    ...
    url = get_env("SYNC_URL", default=server_url_default, required=True)
